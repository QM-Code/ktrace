...
| `jolt.md` | `overseer` | `in progress (resolver fix landed; build-sdk-10 parity + wrapper gates green)` | Decide close-out/archive criteria and whether to centralize asset-path resolver helper beyond parity test. | `2026-02-21` |
| `tests.md` | `overseer` | `in progress (TST-S1/TST-S2/TST-S3 landed; validation green on build-sdk-10)` | Execute `TST-S4`: decompose `physics_backend_parity_test` into multiple parity source files without changing executable/CTest names. | `2026-02-21` |
