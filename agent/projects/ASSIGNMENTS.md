...
| `fallbacks.md` | `overseer` | `in progress (safe fallback cleanup complete; wrapper gates green)` | Decide closure/archive and whether to open a follow-on for SDK-consumer transport-loopback registration diagnostics. | `2026-02-21` |
