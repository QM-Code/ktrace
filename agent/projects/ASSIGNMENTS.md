...
| `multiplatform.md` | `overseer` | `in progress (SDK-only pivot accepted; MP0-SDK1 migration planning active)` | `shared unblocker`: execute `MP0-SDK1` CMake migration (remove `KARMA_INSTALL_ENGINE_SDK` mode branches, preserve target contract) and rerun producer/consumer Linux smoke gates. | `2026-02-21` |
