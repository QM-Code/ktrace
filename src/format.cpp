...
void SetOutputOptions(const OutputOptions& options) {
    ...
    state.line_numbers_enabled.store(options.line_numbers, std::memory_order_relaxed);
    state.function_names_enabled.store(options.function_names, std::memory_order_relaxed);
