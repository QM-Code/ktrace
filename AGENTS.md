...
Execution mechanics (build commands, wrapper gates, handoff mechanics) are defined in `docs/AGENTS.md`.
Overseer workflow is defined in `docs/OVERSEER.md`.
Quick startup orientation is in `docs/STARTUP_BRIEF.md`.
...
2. `docs/AGENTS.md` (execution mechanics and validation policy)
3. `docs/OVERSEER.md` (overseer-only coordination protocol)
4. `docs/projects/<project>.md` (project-specific scope/spec/validation)
5. `docs/DECISIONS.md` (durable strategy/policy decisions and rationale)

## Startup Read Order
1. `docs/STARTUP_BRIEF.md` (quick orientation)
2. `AGENTS.md`
3. `docs/AGENTS.md`
