...
|---|---|---|---|---|
| `client-connection-split.md` | `codex` | `handoff-ready (split complete; follow-up project drafted)` | `shared unblocker`: archive this project after ownership transfer to `engine-game-boundary-hygiene.md`. | `2026-02-17` |
...
| `engine-game-boundary-hygiene.md` | `codex` | `in progress (E0.5 split landed)` | `shared unblocker`: execute E1 extraction by moving hash/path/chunk/manifest primitives into engine-owned modules with no behavior changes. | `2026-02-17` |
